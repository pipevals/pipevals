...
_Alternative considered_: An inline expandable panel below the trigger button. Rejected because it would push the run list down and complicate the layout.
